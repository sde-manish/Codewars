...
//  value. The indices of these items should then be returned in a tuple / list (depending on your language) like so: (index1, index2).
...
//     the items will be numbers; target will always be the sum of two different items from that 
//     array).
// Example:
